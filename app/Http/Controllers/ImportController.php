...
class ImportController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach($jsonData as  $key => $value ){
            ...
            App\Instagram::insert($instagram);
            App\Tags::insert($tags);
            App\Locations::insert($locations);
            App\Comments::insert($comments);
            App\Likes::insert($likes);
            App\Images::insert($images);
            App\Users_in_photo::insert($users_in_photo);
            App\Captions::insert($captions);
            App\Users::insert($users);
        }

        App\Users::insertOrIgnore($usersComments);
        App\Users::insertOrIgnore($usersLikes);
        App\Users::insertOrIgnore($usersPhoto);
        App\Users::insertOrIgnore($usersCaptions);
